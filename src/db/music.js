let musicDB = [
  {
    id: 0,
    name: 'Hua Main',
    author_name: 'Vishal Mishra',
    img: 'Animal.jpg',
    lang: 'HINDI',
    timesPlayed: 0,
    type: 'Romantic',
    musicName: 'Hua Main - Animal.mp3',
    attribution: {
      song: 'Hua Main - Animal',
      musicBy: 'Vishal Mishra',
  ...
  },
  {
    ...
    timesPlayed: 0,
    type: 'Romantic',
    musicName: 'Pehle Bhi Main - Animal 320 Kbps.mp3',
    attribution: {
      song: 'Pehle Bhi Main - Animal',
      musicBy: 'Vishal Mishra',
      download: 'http://ncs.io/Ignite',
      stream: 'http://youtu.be/zbqgv0mMfwk',
    },
  },
  {
    ...
    timesPlayed: 0,
    type: 'Romantic',
    musicName: 'Satranga - Animal 320 Kbps.mp3',
    attribution: {
      song: 'Satranga - Animal',
